...
const populateReimbursementsTable = (listofReimbursements) => {
	...
	for (let reimbursement of listofReimbursements) {
		...
		// Set value of each cell
		 tdRId.textContent = reimbursement.id;
		tdRReq.textContent = reimbursement.requester;
		tdRCst.textContent = reimbursement.cost;
		tdRDsc.textContent = reimbursement.descriptions;
		tdRSts.textContent = reimbursement.status;
